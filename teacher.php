  ...
  <div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="addClass" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <h2 class="text-center"> Add Your Class </h2>
          <hr>
            <div id="add_class_form">
              <select class="form-control" name="year">
              <?php foreach(range(date('Y',time()),2000) as $r) echo '<option>'.$r.'</option>'; ?>
              </select>
              <input class="form-control" name="code" placeholder="Code , Eg: INT-220">
              ...
              <input class="form-control" name="start" placeholder="From Roll Number ,Eg: 101/KM/22 ">
              <input class="form-control" name="end" placeholder="To Roll Number, Eg: 170/KM/22">
